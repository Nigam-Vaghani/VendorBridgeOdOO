...
class RFQ(Base):
    ...
    # Relationships
    items = relationship("RFQItem", backref="rfq", lazy="select", cascade="all, delete-orphan", order_by="RFQItem.item_no")
    rfq_vendors = relationship("RFQVendor", backref="rfq", lazy="select", cascade="all, delete-orphan")
